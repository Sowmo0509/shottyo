...
const BENTO_IMAGES = {
  ...
  accountability: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?q=80&w=800&auto=format&fit=crop",
};
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[320px]">
          ...
          <motion.div
            ...
            className="md:col-span-8 group relative rounded-3xl overflow-hidden bg-card border border-border/50 shadow-sm hover:shadow-2xl hover:border-border transition-all duration-500"
          >
            <div className="absolute inset-0">
              <img
                src={BENTO_IMAGES.document}
                alt={mission.document.title}
                className="w-full h-full object-cover scale-[1.02] group-hover:scale-105 transition-transform duration-1000 ease-out opacity-40 dark:opacity-20 mix-blend-luminosity"
              />
              <div className="absolute inset-0 bg-linear-to-t from-background via-background/80 to-transparent" />
            </div>
            <div className="relative h-full p-8 md:p-12 flex flex-col justify-end">
              <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-primary text-primary-foreground font-bold text-xl mb-6 shadow-lg group-hover:scale-110 transition-transform duration-500">
          ...
          <motion.div
            ...
            className="md:col-span-4 md:row-span-2 group relative rounded-3xl overflow-hidden bg-primary text-primary-foreground shadow-sm hover:shadow-2xl transition-all duration-500"
          >
            <div className="absolute inset-0">
              <img
            ...
            <div className="relative h-full p-8 md:p-10 flex flex-col">
              <div className="flex-1">
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-white/20 text-white font-bold text-xl mb-6 backdrop-blur-md group-hover:scale-110 transition-transform duration-500">
                  {mission.track.title.charAt(0)}
                </div>
              </div>
              <div>
                <h3 className="text-3xl font-bold mb-4 font-dynamic">{mission.track.title}</h3>
                <p className="text-primary-foreground/80 text-lg leading-relaxed">{mission.track.body}</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="md:col-span-4 group relative rounded-3xl bg-muted/50 border border-border/50 p-8 flex flex-col justify-center items-center text-center hover:bg-muted transition-colors duration-500"
          >
            <span className="text-6xl font-bold text-foreground tabular-nums tracking-tighter mb-4">
              <AnimatedNumber value={verdicts} />
            </span>
            <span className="text-base font-semibold text-muted-foreground uppercase tracking-widest">{stats.verdicts}</span>
          </motion.div>
          ...
          <motion.div
            ...
            className="md:col-span-4 group relative rounded-3xl overflow-hidden bg-card border border-border/50 shadow-sm hover:shadow-xl hover:border-border transition-all duration-500 p-8 flex flex-col justify-between"
          >
